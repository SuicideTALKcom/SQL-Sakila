...
WHERE first_name = "GROCHO" AND last_name = "WILLIAMS";
...
FROM (SELECT sl.SID, sbs.manager, sbs.store
    ...
    AS SStore JOIN customer_list cl ON SStore.SID = cl.SID
ORDER BY SStore.SID;
...
-- 8c. You find that you no longer need the view `top_5_genres`. Write a query to delete it.
